...
#define NAU8822_MCLKSEL_MASK		(0x7 << NAU8822_MCLKSEL_SFT)
#define NAU8822_CLKM_SFT			8
#define NAU8822_CLKM_MASK			(0x1 << NAU8822_CLKM_SFT)
#define NAU8822_CLKM_MCLK			(0x0 << NAU8822_CLKM_SFT)
#define NAU8822_CLKM_PLL			(0x1 << NAU8822_CLKM_SFT)


#define NAU8822_WLEN_SFT			5
#define NAU8822_WLEN_20				(0x1 << NAU8822_WLEN_SFT)
#define NAU8822_WLEN_24				(0x2 << NAU8822_WLEN_SFT)
#define NAU8822_WLEN_32				(0x3 << NAU8822_WLEN_SFT)

#define NAU8822_WLEN_MASK			(0x3 << NAU8822_WLEN_SFT)

#define NAU8822_SMPLR_SFT			1
#define NAU8822_SMPLR_MASK			(0x7 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_48K			(0x0 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_32K			(0x1 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_24K			(0x2 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_16K			(0x3 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_12K			(0x4 << NAU8822_SMPLR_SFT)
#define NAU8822_SMPLR_8K			(0x5 << NAU8822_SMPLR_SFT)
...
#define NAU8822_BCLKSEL_MASK		(0x7 << NAU8822_BCLKSEL_SFT)

#define NAU8822_PLL_EN_SFT			5

#define NAU8822_AIFMT_SFT			3
#define NAU8822_AIFMT_MASK			(0x3 << NAU8822_AIFMT_SFT)

#define NAU8822_FSP_IF				(0x1 << 7)
#define NAU8822_BCLKP_IB			(0x1 << 8)

#define NAU8822_CLKIO_MASK			0x1
...
/* Clock divider Id's */
enum {
	NAU8822_MCLK_DIV_PLL,
	NAU8822_MCLK_DIV_MCLK,
	NAU8822_BCLK_DIV,
};
