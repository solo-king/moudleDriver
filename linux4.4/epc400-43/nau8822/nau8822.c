...
int nau8822_check_jd_status(struct snd_soc_codec *codec)
{
	return snd_soc_read(codec, NAU8822_REG_JACK_DETECT_CONTROL_1) & 0x0020;
}
EXPORT_SYMBOL(nau8822_check_jd_status);
				 ...
				 enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_PREPARE:
		printk("[seven] into %s, SND_SOC_BIAS_PREPARE\n",__FUNCTION__);
...
/* for codec porting to raspberrypi 3 */
